...
func (x *ListUsersReqeust) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListUsersReqeust) ProtoMessage() {}

func (x *ListUsersReqeust) ProtoReflect() protoreflect.Message {
	mi := &file_proto_user_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListUsersReqeust.ProtoReflect.Descriptor instead.
func (*ListUsersReqeust) Descriptor() ([]byte, []int) {
	return file_proto_user_proto_rawDescGZIP(), []int{3}
}

func (x *ListUsersReqeust) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.User\x12<\n" +
	"\tListUsers\x12\x16.user.ListUsersReqeust\x1a\x17.user.ListUsersResponseB(Z&github.com/Jihyun3478/study-grpc/protob\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*ListUsersReqeust)(nil),  // 3: user.ListUsersReqeust
...
var file_proto_user_proto_depIdxs = []int32{
	...
	3, // 3: user.UserService.ListUsers:input_type -> user.ListUsersReqeust
